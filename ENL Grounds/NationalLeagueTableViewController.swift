...
class NationalLeagueTableViewController: UITableViewController {
    ...
    var Teams: [String] = ["Aldershot Town","Altrincham","Barnet","Boreham Wood","Bromley","Chesterfield","Dagenham & Redbridge","Dover Athletic","Eastleigh","FC Halifax Town","Grimsby Town","Kings Lynn Town","Macclesfield Town","Maidenhead Utd","Notts County","Solihull Moors","Southend Utd","Stockport County","Torquay Utd","Wealdstone","Weymouth","Woking","Wrexham","Yeovil Town"]
